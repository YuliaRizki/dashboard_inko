...
export default function PaymentPage() {
  return (
    <div className="w-full min-h-screen p-12 space-y-8 flex flex-col items-center justify-center">
      ...
      <motion.div
        ...
        className="w-full max-w-xl glass-panel p-8 relative overflow-hidden group"
      >
        ...
        <div className="relative z-10 space-y-8">
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              ...
              <h2 className="text-4xl font-semibold text-[var(--text-primary)] tracking-tight">
                Rp 150.000
              </h2>
            </div>
            <div className="w-14 h-14 rounded-xl bg-[rgba(255,255,255,0.05)] backdrop-blur-md flex items-center justify-center border border-[var(--glass-border)]">
              <CreditCard className="text-[var(--text-secondary)]" size={24} />
            </div>
          </div>

          <div className="space-y-4">
            <div className="flex justify-between items-center text-[10px] font-bold tracking-widest text-[var(--text-muted)] uppercase">
            ...
            <div className="flex gap-4">
              <div className="flex-1 bg-[rgba(0,0,0,0.2)] rounded-xl p-5 flex items-center justify-center border border-[var(--glass-border)]">
                <code className="text-xl font-mono font-bold tracking-widest text-[var(--text-primary)]">
                  8801 0821 3456 7890
                </code>
              </div>
              <button className="w-14 rounded-xl bg-[rgba(255,255,255,0.05)] border border-[var(--glass-border)] flex items-center justify-center text-[var(--text-primary)] hover:bg-[rgba(255,255,255,0.1)] transition-colors group/btn">
                <Copy
                  size={18}
          ...
          <div className="bg-[rgba(255,255,255,0.03)] p-5 rounded-xl flex gap-4 items-start border border-[var(--glass-border)]">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
                ...
                access will be automatically provisioned.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex gap-4 w-full max-w-xl">
        {["ATM Transfer", "Mobile Banking", "Internet Banking"].map(
          (method) => (
            <button
              key={method}
