        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <div className="flex-1 bg-white/40 rounded-xl p-5 flex items-center justify-center border border-[var(--glass-border)]">
                <code className="text-xl font-mono font-bold tracking-widest text-[var(--text-primary)]">
                  8801 0821 3456 7890
                </code>
              </div>
              <button className="w-14 rounded-xl bg-[var(--ink-bg-fog)] border border-[var(--glass-border)] flex items-center justify-center text-[var(--text-primary)] hover:bg-[rgba(255,255,255,0.1)] transition-colors group/btn">
                <Copy
                  size={18}
